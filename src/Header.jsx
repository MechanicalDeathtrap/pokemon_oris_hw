...
import useStore from "./MainContent.jsx";
/*import pokemonsProps from "./MainContent.jsx"*/
    ...
    return(
        <header className={styles.header}>
            <div className={styles.headerContainer}>
                <img src="src/assets/pokeball.png" alt="poke-ball" className={styles.image}/> {/*PUT AN IMAGE*/}
                ...
                <div className={styles.inputBox}>
                    ...
                    <input type="search" placeholder={"E.g. Pikachu"} className={styles.input} onChange={(e) => searchPokemons(e.target.value)}/>
